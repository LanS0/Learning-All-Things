...
class DetailVideo extends StatefulWidget {
  ...
  const DetailVideo({required this.id, Key? key}) : super(key: key);
...
class _DetailVideoState extends State<DetailVideo> {
  ...
  late Map<String, dynamic> listSeries;
  ...
  void _getVideoByID(String id) async {
    var resp = await BaseClient().getVideoByID("/video", id);
    ...
    setState(() {
      if (dataJson != null) {
        ...
        } else if (dataJson['data']['id'] != '00000000-0000-0000-0000-000000000000' && video.containsKey('series_id')) {
          video = dataJson['data'];
          id = video['id'];
          thumbnail = video['thumbnail'];
          url = video['url'];
